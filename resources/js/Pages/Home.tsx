    ...
    return (
        ...
        <main>
            ...
            <div className="mx-auto my-10 mt-16 max-w-lg text-center sm:max-w-xl sm:px-0 z-10">
                <a className="group mx-auto flex max-w-fit items-center justify-center gap-1 overflow-hidden rounded-full border border-gray-200 bg-white px-4 py-2 shadow-[inset_10px_-50px_94px_0_rgb(199,199,199,0.1)] backdrop-blur transition-all hover:border-gray-300 hover:bg-white/50 sm:px-7" href="/blog/soc2">
